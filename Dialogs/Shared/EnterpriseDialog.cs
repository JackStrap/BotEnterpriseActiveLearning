...
using devBolseBotEnterprise.Dialogs.Cancel;
using devBolseBotEnterprise.Dialogs.Main;
using Luis;
using Microsoft.Bot.Builder.Dialogs;

namespace devBolseBotEnterprise.Dialogs.Shared
{
	public class EnterpriseDialog : InterruptableDialog
	{
		...
		public EnterpriseDialog(BotServices botServices, string dialogId) : base(dialogId)
		{
