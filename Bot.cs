...
using devBolseBotEnterprise.Dialogs.Main;
...
namespace devBolseBotEnterprise
{
	...
	public class Bot : IBot
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="devBolseBotEnterprise"/> class.
		/// </summary>
		...
		public Bot(BotServices botServices, ConversationState conversationState, UserState userState, IBotTelemetryClient telemetryClient)
		{
			...
			_dialogs = new DialogSet(_conversationState.CreateProperty<DialogState>(nameof(devBolseBotEnterprise)));
		...
		public async Task OnTurnAsync(ITurnContext turnContext, CancellationToken cancellationToken)
		{
			...
			DialogContext dc = await _dialogs.CreateContextAsync(turnContext);
